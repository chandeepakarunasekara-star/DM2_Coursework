...
INSERT INTO users (email, full_name, role, password_hash, password_salt, linked_lecturer_id)
SELECT email, full_name, 'LECTURER',
  '1c5121914d1dcf0ab473380e667742ed8853110d9481e7e45ae3b0785d7f3963155680e844bb943584990f49fcf9a3bd155de499db1b6a2f0764c8df70c8a520',
  'oracleseedsalt01', lecturer_id
FROM lecturers;

INSERT INTO users (email, full_name, role, password_hash, password_salt, linked_student_id)
SELECT email, full_name, 'STUDENT',
  '1c5121914d1dcf0ab473380e667742ed8853110d9481e7e45ae3b0785d7f3963155680e844bb943584990f49fcf9a3bd155de499db1b6a2f0764c8df70c8a520',
  'oracleseedsalt01', student_id
FROM students;
